function [HxI_Rmap,HxI_Rsub]=gencorrmap1228(FCS,subid,statspath,statename,cba,cbc)
...
if figflag==1
    ...
    SaveAsAtlasNii(homoxintraLIabsc_R,'/data/stalxy/sharefolder/HCP/AICHA/AICHA.nii',[statspath,'/',statename],['_HomoxIntraLIabs' '_R' '_map'],1)
    ...
    SaveAsAtlasNii(homoxintraLIabsc_R_thrd,'/data/stalxy/sharefolder/HCP/AICHA/AICHA.nii',[statspath,'/',statename],['_HomoxIntraLIabs' '_R' '_THRD'],1)
