...
if figflag==1
%     SaveAsAtlasNii(t_intraLxintraRt,[atlasflag '2'],[statspath,'/',statename],['_IntraLxIntraR' '_T' '_map'],1)
%     
%     SaveAsAtlasNii(homoxintraLc_R,[atlasflag '2'],[statspath,'/',statename],['_HomoxIntraL' '_R' '_map'],1)
%     SaveAsAtlasNii(homoxintraRc_R,[atlasflag '2'],[statspath,'/',statename],['_HomoxIntraR' '_R' '_map'],1)
%     SaveAsAtlasNii(homoxintraLIc_R,[atlasflag '2'],[statspath,'/',statename],['_HomoxIntraLI' '_R' '_map'],1)
    SaveAsAtlasNii(homoxintraLIabsc_R,[atlasflag '2'],[statspath,'/',statename],['_HomoxIntraLIabs' '_R' '_map'],1)
%     SaveAsAtlasNii(intraLxintraRc_R,[atlasflag '2'],[statspath,'/',statename],['_IntraLxIntraR' '_R' '_map'],1)
    
%     SaveAsAtlasNii(t_intraLxintraRt_thrd,[atlasflag '2'],[statspath,'/',statename],['_IntraLxIntraR' '_T' '_THRD'],1)
%     
%     SaveAsAtlasNii(homoxintraLc_R_thrd,[atlasflag '2'],[statspath,'/',statename],['_HomoxIntraL' '_R' '_THRD'],1)
%     SaveAsAtlasNii(homoxintraRc_R_thrd,[atlasflag '2'],[statspath,'/',statename],['_HomoxIntraR' '_R' '_THRD'],1)
%     SaveAsAtlasNii(homoxintraLIc_R_thrd,[atlasflag '2'],[statspath,'/',statename],['_HomoxIntraLI' '_R' '_THRD'],1)
    SaveAsAtlasNii(homoxintraLIabsc_R_thrd,[atlasflag '2'],[statspath,'/',statename],['_HomoxIntraLIabs' '_R' '_THRD'],1)
%     SaveAsAtlasNii(intraLxintraRc_R_thrd,[atlasflag '2'],[statspath,'/',statename],['_IntraLxIntraR' '_R' '_THRD'],1)
    
    
%     NiiProj2Surf([statspath,'/',statename,'_IntraLxIntraR' '_T' '_map','.nii'],surftype,projtype,'hemi',cba);
%     
%     NiiProj2Surf([statspath,'/',statename,'_HomoxIntraL' '_R' '_map','.nii'],surftype,projtype,'hemi',cbc);
%     NiiProj2Surf([statspath,'/',statename,'_HomoxIntraR' '_R' '_map','.nii'],surftype,projtype,'hemi',cbc);
%     NiiProj2Surf([statspath,'/',statename,'_HomoxIntraLI' '_R' '_map','.nii'],surftype,projtype,'hemi',cbc);
    NiiProj2Surf([statspath,'/',statename,'_HomoxIntraLIabs' '_R' '_map','.nii'],surftype,projtype,'hemi',cbc);
%     NiiProj2Surf([statspath,'/',statename,'_IntraLxIntraR' '_R' '_map','.nii'],surftype,projtype,'hemi',cbc);
%     
%     NiiProj2Surf([statspath,'/',statename,'_IntraLxIntraR' '_T' '_THRD','.nii'],surftype,projtype,'hemi',cba);
%     
%     NiiProj2Surf([statspath,'/',statename,'_HomoxIntraL' '_R' '_THRD','.nii'],surftype,projtype,'hemi',cbc);
%     NiiProj2Surf([statspath,'/',statename,'_HomoxIntraR' '_R' '_THRD','.nii'],surftype,projtype,'hemi',cbc);
%     NiiProj2Surf([statspath,'/',statename,'_HomoxIntraLI' '_R' '_THRD','.nii'],surftype,projtype,'hemi',cbc);
    NiiProj2Surf([statspath,'/',statename,'_HomoxIntraLIabs' '_R' '_THRD','.nii'],surftype,projtype,'hemi',cbc);
%     NiiProj2Surf([statspath,'/',statename,'_IntraLxIntraR' '_R' '_THRD','.nii'],surftype,projtype,'hemi',cbc);
%     
