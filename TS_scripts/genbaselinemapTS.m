function genbaselinemapTS(FCS,atlasflag,subid,statpath,statename,colorflag)
% baseline
...
%     NiiProj2Surf([statspath4,'/',statename,'IntraFC_LI_std','.nii'],'inf','tri','hemi',[0 0.2]);
    NiiProj2Surf([statspath5,'/',statename,'IntraFC_LIabs_std','.nii'],'inf','tri','hemi',[0 0.4]);
end
...
%     NiiProj2Surf([statspath2,'/',statename,'IntraR_CV','.nii'],'inf','tri','hemi',[-1 1]);
    NiiProj2Surf([statspath3,'/',statename,'HomoFC_CV','.nii'],'inf','tri','hemi',[-1.5 1.5]);
