...
%     NiiProj2Surf([statspath4,'/',statename,'IntraFC_LI_mean','.nii'],surftype,projtype,'hemi',[-0.3 0.3]);
    NiiProj2Surf([statspath5,'/',statename,'IntraFC_LIabs_mean','.nii'],surftype,projtype,'hemi',[0 0.8]);
%     NiiProj2Surf([statspath4,'/',statename,'IntraFC_LI_std','.nii'],surftype,projtype,'hemi',[0 0.6]);
    NiiProj2Surf([statspath5,'/',statename,'IntraFC_LIabs_std','.nii'],surftype,projtype,'hemi',[0 0.5]);
else
%     NiiProj2Surf([statspath4,'/',statename,'IntraFC_LI_mean','.nii'],surftype,projtype,'hemi',[-0.3 0.3]);
